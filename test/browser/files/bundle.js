...
(function() {
  ...
  console.dir = function() {
    var value;
    return console.log.apply(this, (function() {
      var _i, _len, _results;
      _results = [];
      for (_i = 0, _len = arguments.length; _i < _len; _i++) {
        value = arguments[_i];
        _results.push(inspect(value, false, 3));
      }
      return _results;
...
(function() {
  ...
  utf8ToBytes = function(str) {
    var byteArray, h, i, j, _ref, _ref2;
    byteArray = [];
    for (i = 0, _ref = str.length; 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
      if (str.charCodeAt(i) <= 0x7F) {
        ...
        for (j = 0, _ref2 = h.length; 0 <= _ref2 ? j <= _ref2 : j >= _ref2; 0 <= _ref2 ? j++ : j--) {
    ...
    src.Story = (function() {
      ...
      Story.prototype.initialize = function() {
        ...
        return this.asana.savedAttributes = function(method, model) {
          ...
          if (method !== "POST") delete res.text;
          delete res.target;
          delete res.source;
          delete res.type;
          return res;
...
require.define("/wrapper.coffee", function (require, module, exports, __dirname, __filename) {
  ...
  $(function() {
    ...
    return $("#run").click(function() {
      ...
      key = $("#key").val();
      key = $("#workspace").val();
      return require("./api")(key, workspace);
    });
  });
